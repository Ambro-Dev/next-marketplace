    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          <Img
            src={`${process.env.NEXT_PUBLIC_SERVER_URL}/newsletter-sign-up.png`}
            width="150"
            height="150"
            alt="StickyMarketplace"
            style={logo}
          />
          <Text style={paragraph}>Hi there,</Text>
          <Text style={paragraph}>
            Welcome to StickyMarketplace, the marketplace for high quality
